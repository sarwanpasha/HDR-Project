...
%     end
    ...
    outputFileName = sprintf( 'beta1-%1.2f_beta2-%1.2f_beta3-%1.2f_Duomo2.png' , beta1(i) , beta2(i) , beta3(i) );
    ...
    outputFileName = sprintf( 'ci_beta1-%1.2f_beta2-%1.2f_beta3-%1.2f_Duomo2.png' , beta1(i) , beta2(i) , beta3(i) );
    imwrite( im_norm(log(ci+1)) , outputFileName );

    outputFileName = sprintf( 'tp_beta1-%1.2f_beta2-%1.2f_beta3-%1.2f_Duomo2.png' , beta1(i) , beta2(i) , beta3(i) );
    imwrite( im_norm(log(tp+1)) , outputFileName );
    
    outputFileName = sprintf( 'tq_beta1-%1.2f_beta2-%1.2f_beta3-%1.2f_Duomo2.png' , beta1(i) , beta2(i) , beta3(i) );
    imwrite( im_norm(log(tq+1)) , outputFileName );

end
    
cmpGuidanceShow
tlogStd = log(lumVar+1)./log(2)./2;
tlogMean = log(lumMean+1)./log(2);
